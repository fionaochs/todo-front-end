...
export default class TodoAppLogin extends Component {
    ...
    handleSignIn = async () => {
        const signIn = await request.post(`https://sleepy-journey-35699.herokuapp.com/api/auth/signin`, {
    ...
    handleSignUp = async () => {
        const signUp = await request.post(`https://sleepy-journey-35699.herokuapp.com/api/auth/signup`, {
